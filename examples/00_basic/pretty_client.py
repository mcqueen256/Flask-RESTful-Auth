...
def read_global_text() -> str:
    # TODO: fetch the global text resouce from the server.
    return ''

def read_user_text(username, password) -> str:
    return ''

def write_global_text(content: str):
    return
...
##############################################################################
# Below is application code for the UI
##############################################################################
